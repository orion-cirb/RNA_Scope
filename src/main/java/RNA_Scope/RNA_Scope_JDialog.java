...
public class RNA_Scope_JDialog extends javax.swing.JDialog {
    ...
    public RNA_Scope_JDialog(java.awt.Frame parent, boolean modal) {
        ...
        initComponents();
        main = new RNA_Scope_Main().instance;
    }
    ...
    private List<String> findChannels(String imagesFolder) throws DependencyException, ServiceException, FormatException, IOException {
        ...
        if (main.imagesFiles != null)
            main.imagesFiles.clear();
        int imageNum = 0;
        for (String f : files) {
            ...
            if (fileExt.equals("nd")) {
                ...
                main.imagesFiles.add(imageName);
            }
        }
        return(channels);
    }
    ...
    */
    ...
    private void addStarDistModels() {
        ...
        if (models.length > 0) {
            ...
            jComboBoxNucModel.setSelectedIndex(0);
    ...
    private void initComponents() {
        ...
        jComboBoxNucModel = new javax.swing.JComboBox();
        ...
        jComboBoxGeneThMethod = new javax.swing.JComboBox(autoThresholdMethods);
        ...
        jComboBoxGeneModel = new javax.swing.JComboBox();
        ...
        jFormattedTextFieldGeneRefSingleDotInt.setValue(main.singleDotIntGeneRef);
        jFormattedTextFieldGeneXSingleDotInt.setValue(main.singleDotIntGeneX);
        jComboBoxBgMethod.setSelectedIndex(0);
        jFormattedTextFieldBgRoiSize.setValue(main.roiBgSize);
        jFormattedTextFieldCalibBgGeneRef.setValue(main.calibBgGeneRef);
        jFormattedTextFieldCalibBgGeneX.setValue(main.calibBgGeneX);
        ...
        jComboBoxGeneThMethod.setForeground(java.awt.Color.black);
        jComboBoxGeneThMethod.addItemListener(new java.awt.event.ItemListener() {
            public void itemStateChanged(java.awt.event.ItemEvent evt) {
                jComboBoxGeneThMethodItemStateChanged(evt);
            }
        });
        jComboBoxGeneThMethod.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jComboBoxGeneThMethodActionPerformed(evt);
            }
        });
                        ...
                        .addGroup(jPanelSegparametersLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                            ...
                            .addGroup(jPanelSegparametersLayout.createSequentialGroup()
                                ...
                                .addGroup(jPanelSegparametersLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                    ...
                                    .addComponent(jComboBoxGeneThMethod, 0, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)))
                            .addGroup(jPanelSegparametersLayout.createSequentialGroup()
                                .addGroup(jPanelSegparametersLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                                    .addGroup(jPanelSegparametersLayout.createSequentialGroup()
        ...
        jPanelSegparametersLayout.setVerticalGroup(
            ...
            .addGroup(jPanelSegparametersLayout.createSequentialGroup()
                ...
                .addGroup(jPanelSegparametersLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    ...
                    .addComponent(jLabelThGeneMethod)
                    .addComponent(jComboBoxGeneThMethod, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(jPanelSegparametersLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanelSegparametersLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                        .addComponent(jLabelNucDil2)
        ...
        jFormattedTextFieldMinNucVol.setValue(main.minNucVol);
        jFormattedTextFieldMaxNucVol.setValue(main.maxNucVol);
        jFormattedTextFieldNucDil.setValue(main.nucDil);
        jFormattedTextFieldSecToRemove.setValue(main.removeSlice);
        jComboBoxGeneSegMethod.setSelectedIndex(1);
        jComboBoxGeneThMethod.setSelectedIndex(3);
        jFormattedTextFieldMaxGeneVol.setValue(main.maxGeneVol);
        jFormattedTextFieldMinGeneVol.setValue(main.minGeneVol);
        jFormattedTextFieldDOGMin.setValue(main.DOGMin);
        jFormattedTextFieldDOGMax.setValue(main.DOGMax);
        ...
        layout.setVerticalGroup(
            layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGroup(layout.createSequentialGroup()
                .addComponent(jTabbedPaneRNA_Scope, javax.swing.GroupLayout.PREFERRED_SIZE, 613, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
    ...
    private void jButtonBrowseActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonBrowseActionPerformed
        ...
        if (fileChooser.showOpenDialog(this) == JFileChooser.APPROVE_OPTION) {
            main.imagesFolder = fileChooser.getSelectedFile().getAbsolutePath();
            jTextFieldImagesFolder.setText(main.imagesFolder);
            try {
                chs = findChannels(main.imagesFolder);
        ...
        if (main.imagesFolder != null) {
            main.localImages = true;
    ...
    private void jFormattedTextFieldCalibBgGeneXPropertyChange(java.beans.PropertyChangeEvent evt) {//GEN-FIRST:event_jFormattedTextFieldCalibBgGeneXPropertyChange
        // TODO add your handling code here:
        main.calibBgGeneX = ((Number)jFormattedTextFieldCalibBgGeneX.getValue()).doubleValue();
    ...
    private void jFormattedTextFieldCalibBgGeneRefPropertyChange(java.beans.PropertyChangeEvent evt) {//GEN-FIRST:event_jFormattedTextFieldCalibBgGeneRefPropertyChange
        // TODO add your handling code here:
        main.calibBgGeneRef = ((Number)jFormattedTextFieldCalibBgGeneRef.getValue()).doubleValue();
    ...
    private void jComboBoxGeneXChActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jComboBoxGeneXChActionPerformed
        // TODO add your handling code here:
        if (actionListener)
        main.channels.add(2, jComboBoxGeneXCh.getSelectedItem().toString());
    ...
    private void jFormattedTextFieldBgRoiSizePropertyChange(java.beans.PropertyChangeEvent evt) {//GEN-FIRST:event_jFormattedTextFieldBgRoiSizePropertyChange
        // TODO add your handling code here:
        main.roiBgSize = ((Number)jFormattedTextFieldBgRoiSize.getValue()).intValue();
    ...
    private void jComboBoxGeneRefChActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jComboBoxGeneRefChActionPerformed
        // TODO add your handling code here:
        if (actionListener)
        main.channels.add(1, jComboBoxGeneRefCh.getSelectedItem().toString());
    ...
    private void jComboBoxBgMethodActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jComboBoxBgMethodActionPerformed
        // TODO add your handling code here:
        main.autoBackground = jComboBoxBgMethod.getSelectedItem().toString();
    ...
    private void jComboBoxDAPIChActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jComboBoxDAPIChActionPerformed
        // TODO add your handling code here:
        if (actionListener)
        main.channels.add(0, jComboBoxDAPICh.getSelectedItem().toString());
    ...
    private void jFormattedTextFieldGeneXSingleDotIntPropertyChange(java.beans.PropertyChangeEvent evt) {//GEN-FIRST:event_jFormattedTextFieldGeneXSingleDotIntPropertyChange
        // TODO add your handling code here:
        main.singleDotIntGeneX = ((Number)jFormattedTextFieldGeneXSingleDotInt.getValue()).doubleValue();
    ...
    private void jFormattedTextFieldGeneRefSingleDotIntPropertyChange(java.beans.PropertyChangeEvent evt) {//GEN-FIRST:event_jFormattedTextFieldGeneRefSingleDotIntPropertyChange
        // TODO add your handling code here:
        main.singleDotIntGeneRef = ((Number)jFormattedTextFieldGeneRefSingleDotInt.getValue()).doubleValue();
    ...
    private void jComboBoxNucSegMethodItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_jComboBoxNucSegMethodItemStateChanged
        // TODO add your handling code here:
        main.nucSegMethod = jComboBoxNucSegMethod.getSelectedItem().toString();
        if(main.nucSegMethod.equals("StarDist")) {
           jComboBoxNucThMethod.setEnabled(false);
           jComboBoxNucModel.setEnabled(true);
        }
        else {
           jComboBoxNucThMethod.setEnabled(true);
           jComboBoxNucModel.setEnabled(false);
        }
    ...
    private void jComboBoxNucModelItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_jComboBoxNucModelItemStateChanged
        // TODO add your handling code here:
        main.stardistModelNucleus = modelsPath+File.separator+jComboBoxNucModel.getSelectedItem().toString();
    ...
    private void jFormattedTextFieldMinNucVolActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jFormattedTextFieldMinNucVolActionPerformed
        // TODO add your handling code here:
        main.minNucVol =  ((Number)jFormattedTextFieldMinNucVol.getValue()).doubleValue();
    ...
    private void jFormattedTextFieldMaxNucVolActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jFormattedTextFieldMaxNucVolActionPerformed
        // TODO add your handling code here:
        main.maxNucVol =  ((Number)jFormattedTextFieldMaxNucVol.getValue()).doubleValue();
    ...
    private void jFormattedTextFieldNucDilActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jFormattedTextFieldNucDilActionPerformed
        // TODO add your handling code here:
        main.nucDil =  ((Number)jFormattedTextFieldNucDil.getValue()).floatValue();
    ...
    private void jFormattedTextFieldSecToRemoveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jFormattedTextFieldSecToRemoveActionPerformed
        // TODO add your handling code here:
        main.removeSlice = ((Number)jFormattedTextFieldSecToRemove.getValue()).intValue();
    ...
    private void jCheckBoxNumberNucleusItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_jCheckBoxNumberNucleusItemStateChanged
        // TODO add your handling code here:
        main.nucNumber = jCheckBoxNumberNucleus.isSelected();
    ...
    private void jComboBoxGeneSegMethodItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_jComboBoxGeneSegMethodItemStateChanged
        // TODO add your handling code here:
        main.geneSegMethod = jComboBoxGeneSegMethod.getSelectedItem().toString();
        if(main.geneSegMethod.equals("StarDist")) {
           jComboBoxGeneThMethod.setEnabled(false);
           jComboBoxGeneModel.setEnabled(true);
           jFormattedTextFieldDOGMin.setEnabled(false);
           jFormattedTextFieldDOGMax.setEnabled(false);
        }
        else {
           jComboBoxGeneThMethod.setEnabled(true);
           jComboBoxGeneModel.setEnabled(false);        
           jFormattedTextFieldDOGMin.setEnabled(true);
           jFormattedTextFieldDOGMax.setEnabled(true);
    ...
    private void jComboBoxGeneThMethodItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_jComboBoxGeneThMethodItemStateChanged
        // TODO add your handling code here:
        main.geneThMethod = jComboBoxGeneThMethod.getSelectedItem().toString(); 
    }//GEN-LAST:event_jComboBoxGeneThMethodItemStateChanged

    private void jComboBoxGeneThMethodActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jComboBoxGeneThMethodActionPerformed
        // TODO add your handling code here:
        main.geneThMethod = jComboBoxGeneThMethod.getSelectedItem().toString(); 
    }//GEN-LAST:event_jComboBoxGeneThMethodActionPerformed
    ...
    private void jFormattedTextFieldMaxGeneVolActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jFormattedTextFieldMaxGeneVolActionPerformed
        // TODO add your handling code here:
        main.maxGeneVol =  ((Number)jFormattedTextFieldMaxGeneVol.getValue()).doubleValue();
    ...
    private void jFormattedTextFieldMinGeneVolActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jFormattedTextFieldMinGeneVolActionPerformed
        // TODO add your handling code here:
        main.minGeneVol =  ((Number)jFormattedTextFieldMinGeneVol.getValue()).doubleValue();
    ...
    private void jFormattedTextFieldDOGMinActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jFormattedTextFieldDOGMinActionPerformed
        // TODO add your handling code here:
        if (!jFormattedTextFieldDOGMin.getText().isEmpty())
            main.DOGMin =  ((Number)jFormattedTextFieldDOGMin.getValue()).doubleValue();
    ...
    private void jFormattedTextFieldDOGMaxActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jFormattedTextFieldDOGMaxActionPerformed
        // TODO add your handling code here:
        if (!jFormattedTextFieldDOGMax.getText().isEmpty())
            main.DOGMax =  ((Number)jFormattedTextFieldDOGMax.getValue()).doubleValue();
    ...
    private void jComboBoxNucThMethodItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_jComboBoxNucThMethodItemStateChanged
        // TODO add your handling code here:
        main.nucThMethod = jComboBoxNucThMethod.getSelectedItem().toString();
    ...
    private void jComboBoxGeneModelItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_jComboBoxGeneModelItemStateChanged
        // TODO add your handling code here:
        main.stardistModelGenes= modelsPath+File.separator+jComboBoxGeneModel.getSelectedItem().toString();
    ...
    private javax.swing.JComboBox jComboBoxGeneThMethod;
